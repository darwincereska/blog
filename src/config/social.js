export default {
  networks: [
    {
      name: 'youtube',
      url: 'https://www.youtube.com/@durrwinzz?sub_confirmation=1',
    ...
    {
      name: 'rss',
      url: 'https://blog.durrstudios.dev/rss.xml',
      svg : '<svg class="transition-all w-6 h-6 cursor-pointer text-zinc-400 hover:text-[#ff4d4d] fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 64C0 46.3 14.3 32 32 32c229.8 0 416 186.2 416 416c0 17.7-14.3 32-32 32s-32-14.3-32-32C384 253.6 226.4 96 32 96C14.3 96 0 81.7 0 64zM0 416a64 64 0 1 1 128 0A64 64 0 1 1 0 416zM32 160c159.1 0 288 128.9 288 288c0 17.7-14.3 32-32 32s-32-14.3-32-32c0-123.7-100.3-224-224-224c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg>'
    }
  ],
};
